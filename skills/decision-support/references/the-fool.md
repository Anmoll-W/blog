...
- "Question assumptions", then Ask: "Expose my assumptions" (Socratic) vs "Test the evidence" (Falsification)
- "Find weaknesses", then Ask: "Find failure modes" (Pre-mortem) vs "Attack this" (Red team)
- "Build counter-arguments", then Skip step 2, proceed with Dialectic synthesis
- "You choose", then Skip step 2, load `references/mode-selection-guide.md` and auto-recommend
