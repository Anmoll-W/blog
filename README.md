...
|--------|-------|----------------|
| [Vault as OS](series/vault-as-os.md) | 20 | Building an Obsidian vault into an automated knowledge system with AI personas, scheduled agents, and enforced session behavior |
