...
- [Six Parallel Agents, Roughly 140 Search Queries, and a Ceiling That Was Not About Effort](six-agents-effort-ceiling.md): the same pattern applied to sourcing instead of a build sprint, and the case where running more agents in parallel stops being the answer
