...
- [The Claims Were There. The Sources Were Not.](claims-without-sources.md) — how the weekly-review runner built here was extended to sweep hypothesis staleness across four projects
...
- [We Designed a Multi-Model Router. Then We Asked One Question.](right-model-wrong-problem.md) — the Gemini Flash research leg that now plugs into morning-briefing and weekly-review; these runners carry the RESEARCH CONTEXT injection across every run
- [Why I Shut Down Hermes — a Multi-Agent AI System I Built Myself](why-i-shut-down-hermes.md) — the shutdown post; the Mac-side runner architecture documented here replaced the Railway gateway as the primary delivery vehicle after Hermes was decommissioned
