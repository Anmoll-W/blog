...
- [Most AI Builds Start at Step Four. Here Is the Order I Default To.](the-order-you-build-ai-in.md): where this kind of problem-space work sits in a seven-stage design order, and what specifically breaks downstream when a team skips it and starts at the model
