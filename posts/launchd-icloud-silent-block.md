...
- [Analytics Said Zero. The Order System Said Otherwise.](analytics-said-zero.md): the same "the system reports nothing wrong because it cannot see the failure" pattern, in an analytics pipeline instead of a scheduling layer
