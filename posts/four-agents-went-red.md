...
- [Six Parallel Agents, Roughly 140 Search Queries, and a Ceiling That Was Not About Effort](six-agents-effort-ceiling.md): a companion lesson on scaling agents. Knowing when more agents is not the answer applies whether the wall is quality or population size
