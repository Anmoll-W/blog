...
- [My Agents Were Calling Skills That Did Not Exist](agents-calling-skills-that-do-not-exist.md): the next time another product manager's agent work sent me back to my own. That started with a repository; this one started with a single skill they posted
