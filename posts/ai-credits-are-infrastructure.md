...
- [A Knowledge Base an LLM Can Query, With No Vector Database](knowledge-base-no-vector-database.md): the same build-vs-buy framing applied to a retrieval architecture. Infrastructure is a cost decision before it is an engineering one
