...
- [Upgrading My AI Agent Roster, and the Baseline I Forgot to Save](personas-180-of-180-and-no-baseline.md) — the direct sequel to the yes-man problem: a depth upgrade with dissent protocol, refusal catalogs, banned-phrase scans, and the eval that caught what the eval itself could not catch
