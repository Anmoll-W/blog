...
- [Six Parallel Agents, Roughly 140 Search Queries, and a Ceiling That Was Not About Effort](six-agents-effort-ceiling.md): a six-agent dispatch that leaned on this same discipline, checking what each agent actually did with its budget before deciding whether to run more of them
