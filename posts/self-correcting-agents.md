...
- [My Agents Were Calling Skills That Did Not Exist](agents-calling-skills-that-do-not-exist.md): the same discovery one layer down. Here the personas were not executing their protocols; there the skills those protocols name had stopped resolving at all
